...
ifeq ($(GROUND_SOFTWARE), yamcs)
	...
	cd $(GSWBUILDDIR) && cmake $(PREP_OPTS) -DSA_FILE=OFF -DSUPPORT=1 -DCRYPTO_LIBGCRYPT=1 -DSA_INTERNAL=1 -DMC_INTERNAL=1 -DKEY_INTERNAL=1 ../../components/cryptolib
endif
