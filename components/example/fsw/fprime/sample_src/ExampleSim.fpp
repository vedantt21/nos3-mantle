module Components {
    ...
    active component ExampleSim {
        ...
        @ Command to initialize Sequence Example HK
        async command EXAMPLE_SEQ(
        )
        ...
        @ A Count of Successful Commands from FSW to Example
        telemetry CommandCount: U32

        @ A Count of Unsuccessful Commands from FSW to Example
