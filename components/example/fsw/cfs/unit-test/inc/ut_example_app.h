 ...
 *
 * Purpose:
 * Extra scaffolding functions for the example_app unit test
 *
 * Notes:
...
#ifndef UT_EXAMPLE_APP_H
#define UT_EXAMPLE_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "EXAMPLE_APP_Data_t" typedef.
 */
#include "example_app.h"

/*
 * Allow UT access to the global "EXAMPLE_APP_Data" object.
 */
// extern EXAMPLE_AppData_t EXAMPLE_APP_Data;

#endif /* UT_EXAMPLE_APP_H */
