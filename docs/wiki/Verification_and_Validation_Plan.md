# 1 Introduction
This verification and validation plan applies to the NASA Operational Simulator (NOS).  NOS is described in more detail in the User's Manual and Developer's Guide and section 3.
...
Testing will be the main method of validation.  As much as possible, it should be automated using the UT-Assert framework and, if possible, should provide pass/fail results.
