# 1 Introduction
This verification and validation plan applies to the NASA Operational Simulator (NOS).  NOS is described in more detail in section 3.
## 1.1 Purpose and Scope
NOS is a suite of tools developed by NASA's Katherine Johnson Independent Verification and Validation (IV&V) Facility to aid in areas such as software development, integration & test (I&T), mission operations/training, verification and validation (V&V), and software systems check-out. NOS provides a software development environment, a multi-target build system, an operator interface/ground station, dynamics and environment simulations, and software-based models of spacecraft hardware.
...
The NASA Independent Verification and Validation (IV&V) Independent Test Capability (ITC) team and the NOS maintainers are responsible for maintenance of this plan.  This group has the authority to approve changes to this plan.
## 1.3 Definitions
...
2. User's Manual and Developer's Guide
3. Comprehensive Performance Tests
4. Limited Performance Tests
5. Requirements
6. Requirements Traceability Matrix (RTM)
## 2.2 Reference Documents
1. Software Development / Management Plan
## 2.3 Order of Precedence
In case of conflicts, the applicable documents take precedence over this document.  This document takes precedence over the reference documents.
...
The NASA IV&V ITC team is responsible for verification and validation of NOS.
...
4.  Ground softawre command and telemetry database development
